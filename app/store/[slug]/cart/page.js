...
import {
    FiMinus, FiPlus, FiTrash2, FiShoppingBag, FiChevronRight,
    FiShield, FiTruck, FiTag,
} from "react-icons/fi";
...
function CartItemRow({ item, productUrl, onUpdateQuantity, onRemove }) {
    ...
    return (
        <li className="ct-row">
            <Link href={productUrl} className="ct-row-img">
                <Image
            ...
            <div className="ct-row-body">
                <div className="ct-row-top">
                    <div className="ct-row-info">
                        <Link href={productUrl} className="ct-row-name">
                            {item.name}
                        </Link>
                        <p className="ct-row-store">{item.category || "Produit"}</p>
...
export default function CartPage() {
    const {
        store, cart, cartSubtotal, shippingFee, cartTotal,
    ...
    const productUrlFor = (id) => (isLocalhost ? `/store/${slug}/product/${id}` : `/product/${id}`);
    ...
    return (
        <div className="ct-page">
            ...
            <nav className="ct-breadcrumb">
                <Link href={homeUrl} className="ct-breadcrumb-link">Accueil</Link>
            ...
            <div className="ct-layout">
                ...
                <section className="ct-items-col">
                    <div className="ct-items-card">
                        <div className="ct-items-header">
                            ...
                            <Link href={homeUrl} className="ct-continue-link">
                        ...
                        <ul className="ct-items-list">
                            {cart.map((item) => (
                                <CartItemRow
                                    key={item.cartItemId}
                                    item={item}
                                    productUrl={productUrlFor(item.id)}
                ...
                <aside className="ct-summary-col">
                    <div className="ct-summary-card">
                        ...
                        <Link href={checkoutUrl} className="ct-btn-primary-full">
                            Passer à la caisse
                        </Link>
                    </div>
                </aside>
